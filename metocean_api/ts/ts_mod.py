...
class TimeSeries:
    ...
    def import_data(self, save_csv=True, save_nc=False, use_cache=False):
        if (self.product == "NORA3_wave_sub") or (self.product == "NORA3_wave"):
            ...
            self.data = metno.NORKYST800_ts(self, save_csv, save_nc, use_cache)
            ...
            self.data = metno.NorkystDA_surface_ts(self, save_csv, save_nc, use_cache)
        elif self.product == "NorkystDA_zdepth":
            self.variable = ["u", "v", "zeta", "temp", "salt", "AKs"]
            self.data = metno.NorkystDA_zdepth_ts(self, save_csv, save_nc, use_cache)
